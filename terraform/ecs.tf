  ...
  container_definitions = {
    wordpress = {
      ...
      environment = [
        ...
        {
          name  = "APACHE_MODULES"
          value = "mpm_event_module unixd_module log_config_module mime_module dir_module autoindex_module alias_module rewrite_module env_module headers_module setenvif_module"  # Added mpm_event_module
        },
        {
          name  = "APACHE_PREFIX"
